...
Some games utilize Default Display Resolution to set game's output resolution. List of known compatible games can be found [HERE](https://github.com/masagrator/ReverseNX-RT/tree/compatible_games). Some games may use that function, but do nothing with the result (For example `Dragon Ball: Xenoverse 2`)
